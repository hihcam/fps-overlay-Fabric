...
public class PerformanceTracker {
    ...
    public void update(class_310 client) {
        ...
        this.currentFps = Math.max(0, client.method_47599());
    ...
    private double fetchGpuUsage(class_310 client) {
        ...
        try {
            double utilization = client.method_41734();
    ...
    private int fetchCurrentPing(class_310 client) {
        var handler = client.method_1562();
        ...
        try {
            var entry = handler.method_2871(player.method_5667());
            return entry != null ? Math.max(0, entry.method_2959()) : 0;
        } catch (Exception e) {
            return 0;
        }
    }
    ...
    private TickData fetchTickData(class_310 client) {
        var server = client.method_1576();
        if (server != null) {
            double mspt = server.method_54832();
    ...
    private ChunkData fetchChunkData(class_310 client) {
        if (client.field_1687 == null) {
            return new ChunkData(0, 0, 0);
        }

        try {
            int loaded = client.field_1687.method_2935().method_14151();
            int visible = (int) Math.round(client.field_1769.method_34811());
            int completed = client.field_1769.method_3246();
    ...
    private LocationData fetchLocationData(class_310 client) {
        ...
        try {
            ...
            String coordinates = pos.method_10263() + " " + pos.method_10264() + " " + pos.method_10260();
            String biome = client.field_1687.method_23753(pos).method_40230()
                    .map(key -> class_2561.method_43471(key.method_29177().method_42093("biome")).getString())
                    .orElse("Unknown");
