...
public final class WindowsGpuUsageProvider implements GpuUsageProvider {
    ...
    private static final WindowsGpuUsageProvider INSTANCE = new WindowsGpuUsageProvider();
    ...
    private WindowsGpuUsageProvider() {
    }

    public static WindowsGpuUsageProvider getInstance() {
        return INSTANCE;
    }
