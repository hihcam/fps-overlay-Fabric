...
public enum OverlayMetric {
    ...
    CPU("cpu", "text.fps_overlay.cpu_short", "text.fps_overlay.cpu", "text.fps_overlay.percent"),
    GPU("gpu", "text.fps_overlay.gpu_short", "text.fps_overlay.gpu", "text.fps_overlay.percent"),
